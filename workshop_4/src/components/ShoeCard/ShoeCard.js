...
const ShoeCard = ({
  ...
  // prettier-ignore
  const variant = typeof salePrice === 'number' ? 'on-sale'
...
const Price = styled.span`
  color: ${props => props.isSale ? COLORS.gray[700] : COLORS.gray[900]};
...
const SaleTag = styled(ItemTag)`
  background-color: ${COLORS.primary};
`;

const NewTag = styled(ItemTag)`
